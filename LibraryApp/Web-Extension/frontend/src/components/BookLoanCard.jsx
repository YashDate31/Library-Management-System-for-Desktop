  ...
  return (
    <Card className={`flex flex-col h-full transition-shadow hover:shadow-md ${className}`}>
      ...
      <div className="flex-1 mb-4">
        <h3 className="text-lg font-bold text-slate-900 leading-tight mb-1 line-clamp-2" title={title}>
          {title}
        </h3>
        <p className="text-sm text-slate-500 font-medium mb-3 line-clamp-1">{author}</p>
